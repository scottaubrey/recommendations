...
abstract class WebTestCase extends SilexWebTestCase
{
    ...
    public function addPodcastEpisode(int $number, array $chapters, DateTimeImmutable $published)
    {
        ...
        $podcastEpisode = $builder->create(PodcastEpisode::class)
            ->withNumber($number)
            ->withThumbnail(
                new Image('', 'https://iiif.elifesciences.org/thumbnail.jpg', new ArraySequence(['By some person.']), new File('image/jpeg', 'https://iiif.elifesciences.org/thumbnail.jpg/full/full/0/default.jpg', 'thumbnail.jpg'), 140, 140, 50, 50)
            )
            ->withChapters(
                new ArraySequence(
